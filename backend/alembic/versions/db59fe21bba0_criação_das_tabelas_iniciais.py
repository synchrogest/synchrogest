...
def upgrade() -> None:
    ...
    # Criar tipos ENUM antes das tabelas
    nivel_acesso_enum = postgresql.ENUM('admin', 'usuario', 'visualizacao', name='nivel_acesso_enum')
    nivel_acesso_enum.create(op.get_bind(), checkfirst=True)

    status_enum = postgresql.ENUM('planejamento', 'em_andamento', 'concluido', 'cancelado', name='status_enum')
    status_enum.create(op.get_bind(), checkfirst=True)

    tipo_enum = postgresql.ENUM('entrada', 'saida', name='tipo_enum')
    ...
    sa.Column('nivel_acesso', nivel_acesso_enum, nullable=True),
...
def downgrade() -> None:
    ...
    # Remover ENUMs ao final
    op.execute('DROP TYPE IF EXISTS nivel_acesso_enum')
