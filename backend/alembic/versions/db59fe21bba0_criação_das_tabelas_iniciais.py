...
def upgrade() -> None:
    ...
    sa.Column('nivel_acesso', sa.Enum('admin', 'usuario', 'visualizacao'), nullable=True),
    ...
    sa.Column('status', sa.Enum('planejamento', 'em_andamento', 'concluido', 'cancelado'), nullable=True),
    sa.Column('descricao', sa.Text(), nullable=True),
    sa.Column('data_criacao', sa.DateTime(), nullable=True),
    sa.Column('data_atualizacao', sa.DateTime(), nullable=True),
